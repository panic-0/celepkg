...
export type ProgressFilter = "all" | "completed" | "unfinished" | "withStats" | "warnings" | "updates";
export type SortKey = "name" | "deaths" | "time" | "strawberries";
export type StrawberryDenominator = "visible" | "total";
export type ActiveView = "maps" | "mods" | "downloads" | "everest" | "catalog" | "profiles" | "settings" | "backups";
