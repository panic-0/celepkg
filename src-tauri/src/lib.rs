...
pub fn run() {
    tauri::Builder::default()
        .invoke_handler(tauri::generate_handler![
            ...
            commands::set_auto_refresh_mod_catalog_cache_on_startup,
            ...
            commands::refresh_mod_catalog_cache,
            commands::check_mod_updates,
            commands::preview_mod_update_metadata,
            commands::list_everest_releases,
            commands::download_everest_to_staging,
            commands::install_staged_everest,
            commands::download_mod_to_staging,
            commands::install_staged_mod,
